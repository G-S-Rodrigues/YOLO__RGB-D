...
video_path_out = os.path.join(VIDEOS_DIR, 'swincarTripVinha_out.mp4')
...
model_path = '/home/guilh/Robotics4Farmers/Machine_Learning/Detection/YOLOv9/runs/train2/weights/best.pt'
